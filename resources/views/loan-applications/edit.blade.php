     ...
     <div class="nk-block-head nk-block-head-sm">
        ...
        <div class="nk-block-between g-3">
           <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Application Details ({{$data->loan_name??'-'}})</h3>
            <div class="nk-block-des text-soft">
             <p>Details of applied loan data and documents</p>
         </div>
     </div>
     <div class="nk-block-head-content"><a href="{{url('loan-applications')}}" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>Back</span></a><a href="{{url('loan-applications')}}" class="btn btn-icon btn-outline-light bg-white d-inline-flex d-sm-none"><em class="icon ni ni-arrow-left"></em></a></div>
 </div>
</div>
<div class="nk-block">
  <div class="row g-gs">
   <div class="col-lg-4 col-xl-4 col-xxl-3">
    <div class="card">
     ...
     <form method="POST" action="{{url('loan-applications')}}/status/{{$data->id}}">
        @csrf
        <div class="row">
         ...
         <div class="col-lg-12" style="text-align: left;">
            <div class="form-group" style="margin-bottom: 8px;">
                ...
                <div class="form-control-wrap">
                    <select class="form-control form-select" onchange="hideClass(this.value)" name="status">
           ...
           <div class="row">
            ...
            <div class="col-lg-6 mt-2">
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        <input type="text" class="form-control" value="{{$data->middle_name ?? '-'}}" name="first_name" disabled placeholder="Enter Middle Name" id="full-name-1">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 mt-2">
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        <input type="text" class="form-control" value="{{$data->requested_amount ?? '-'}}" name="first_name" disabled placeholder="Enter Email" id="full-name-1">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 mt-2">
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        <input type="text" class="form-control" value="{{$data->requested_duration ?? '0'}} Month" name="first_name" disabled placeholder="Enter Email" id="full-name-1">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 mt-2">
            ...
            <div class="col-lg-6 mt-2">
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        <input type="text" class="form-control" value="{{$data->company_type ?? '-'}}" name="first_name" disabled placeholder="Enter Email" id="full-name-1">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 mt-2">
            ...
            <div class="col-lg-6 mt-2">
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        <input type="text" class="form-control" value="{{$data->residence_pincode ?? '-'}}" name="first_name" disabled placeholder="Enter Email" id="full-name-1">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 mt-2">
