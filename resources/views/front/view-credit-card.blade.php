  ...
  <section class="content">
    <div class="card">
      <div class="card-header">
        <div class="row">
						<div class="col-10">
              <h3 class="card-title">Lead #{{5000+$data->id}}</h3>
						</div>
						<div class="col-2">
													</div>
					</div>
            ...
            <div class="card-deck">
              <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                  ...
                  <p class="text-center">
                    <span class="text-muted">{{$data->gender ?? ''}}</span><br>
                    <span class="text-muted">{{date('d-m-Y',strtotime($data->dob)) ?? '-'}}</span><br>
                    <span class="text-muted"><i class="fas fa-envelope"></i> {{$data->email}}</span><br>
                    <span class="text-muted"><i class="fas fa-mobile-alt"></i> {{$data->mobile_number}}</span>
                  </p>
                </div>
              </div>
              <div class="card card-primary card-outline">
                <div class="card-body">
                  ...
                  <hr>
                  <strong>Employment Type: </strong><p class="text-muted">{{$data->employment_type}}</p>
                  <hr>
                  <strong>Monthly Salary : </strong><p class="text-muted">Rs. {{number_format($data->income_salary)}}</p>
                </div>
              </div>
              <div class="card card-primary card-outline">
                <div class="card-body">
                  ...
                  <table class="table">
                    ...
                    <tr>
                      <th class="text-muted">{{$data->current_pincode}}</th>
                      <th class="text-muted">{{$data->office_pincode}}</th>
                      <th class="text-muted">{{$data->permanent_pincode}}</th>
                    </tr>
                  </table>
                  <hr>
                  <strong>Have Credit Card: </strong><p class="text-muted">
                    {{$data->existing_card == 0 ? 'No' : 'Yes'}}
                  </p>
                </div>
              </div>
            </div>
