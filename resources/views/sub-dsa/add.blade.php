                            ...
                            <form method="POST" action="{{url('sub-dsa/add')}}" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control @error('mobile_number') is-invalid @enderror" value="{{old('mobile_number')}}" name="mobile_number" placeholder="Enter Mobile Number"  onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="10" id="full-name-5">
                                            @error('mobile_number')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control @error('whatsapp_number') is-invalid @enderror" maxlength="10"  onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="{{old('whatsapp_number')}}" name="whatsapp_number" placeholder="Enter Whatsapp Number" id="full-name-6">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control @error('aadhar_number') is-invalid @enderror" value="{{old('aadhar_number')}}" name="aadhar_number" placeholder="Enter Aadhar Number" maxlength="12" onkeypress='return event.charCode >= 48 && event.charCode <= 57' id="full-name-8">
                                            @error('aadhar_number')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
