                            ...
                            <form method="POST" action="{{url('loan-types/add')}}" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" value="{{old('name')}}" name="name" placeholder="eg. Personal Loan" id="full-name-1" onkeypress="return (event.charCode > 64 && 
