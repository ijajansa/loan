                ...
                <div class="nk-block nk-block-lg">
                    ...
                    <div class="card card-bordered card-preview">
                        <div class="card-inner">
                            <form method="POST" action="<?php echo e(url('sub-dsa/edit')); ?>/<?php echo e($data->id); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="row g-4">
                                   <div class="col-lg-12">
...
unset($__errorArgs, $__bag); ?>" name="agent_id">
                                                ...
                                                <option value="<?php echo e($agent->id); ?>" <?php if(old('agent_id',$data->agent_id)==$agent->id): ?> selected  <?php endif; ?> ><?php echo e($agent->first_name.' '.$agent->last_name); ?></option>
...
<?php echo $__env->make('admin-layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp1\htdocs\loan-project\resources\views/sub-dsa/edit.blade.php ENDPATH**/ ?>