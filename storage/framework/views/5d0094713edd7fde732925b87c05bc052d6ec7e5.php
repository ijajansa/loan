...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('mobile_number')); ?>" name="mobile_number" placeholder="Enter Mobile Number" id="full-name-5" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="10">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('whatsapp_number')); ?>" name="whatsapp_number" placeholder="Enter Whatsapp Number" id="full-name-6" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="10">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('aadhar_number')); ?>" name="aadhar_number" placeholder="Enter Aadhar Number" id="full-name-8" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="12">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('pincode')); ?>" name="pincode" placeholder="Enter Pincode" id="full-name-12" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="6">
