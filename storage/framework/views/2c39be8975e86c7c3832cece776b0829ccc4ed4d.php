...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('first_name',$data->first_name)); ?>" name="first_name" placeholder="Enter First Name" id="full-name-1" onkeypress="return (event.charCode > 64 && 
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('middle_name',$data->middle_name)); ?>" name="middle_name" placeholder="Enter Middle Name" id="full-name-2" onkeypress="return (event.charCode > 64 && 
                                            event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode ==32)">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('last_name',$data->last_name)); ?>" name="last_name" placeholder="Enter Last Name" id="full-name-3" onkeypress="return (event.charCode > 64 && 
                                            event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode ==32)">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('mobile_number',$data->mobile_number)); ?>" name="mobile_number" placeholder="Enter Mobile Number" id="full-name-5" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="10">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('whatsapp_number',$data->whatsapp_number)); ?>" name="whatsapp_number" placeholder="Enter Whatsapp Number" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="10" id="full-name-6">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('aadhar_number',$data->aadhar_number)); ?>" name="aadhar_number" placeholder="Enter Aadhar Number" id="full-name-8" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="12">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('gst_number',$data->gst_number)); ?>" name="gst_number" placeholder="Enter GST Number" id="full-name-10" maxlength="15" onkeypress='return (event.charCode >= 48 && event.charCode <= 57) || (event.charCode > 64 && event.charCode < 91)' >
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('pincode',$data->pincode)); ?>" name="pincode" placeholder="Enter Pincode" id="full-name-12" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="6">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('city',$data->city)); ?>" name="city" placeholder="City" onkeypress="return (event.charCode > 64 && 
                                                    event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode ==32)">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('state',$data->state)); ?>" name="state" placeholder="State" onkeypress="return (event.charCode > 64 && 
                                                    event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode ==32)">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('country',$data->country)); ?>" name="country" placeholder="Country" onkeypress="return (event.charCode > 64 && 
                                                    event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode ==32)">
