    ...
    function deleteRecord(id) {
        if ($.trim(id)) {
            Swal.fire({
                ...
                if (result.value) 
                {
                    window.location.href="<?php echo e(url('dsa/delete')); ?>/"+id;
                }
            });
        }
    }
    ...
    function changeStatus(id) {
        if ($.trim(id)) {
            Swal.fire({
                ...
                if (result.value) 
                {
                    window.location.href="<?php echo e(url('dsa/status')); ?>/"+id;
                }
            });
        }
    }
...
<?php echo $__env->make('admin-layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp1\htdocs\loan-project\resources\views/agents/all.blade.php ENDPATH**/ ?>